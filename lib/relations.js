...
function createParentChild() {
    ...
    return {
        parent: presets.Component(masterWrapper),
        child: presets.Component(slaveWrapper)
    }
}
...
function createAncestorDescendant() {
    ...
    return {
        ancestor: presets.Component(masterWrapper),
        descendant: presets.Component(slaveWrapper)
    }
}
